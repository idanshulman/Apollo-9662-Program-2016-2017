...
@Autonomous(name="BLUEY", group="AUTONOMUS")
//@Disabled
public class Autonomous_BLUEY extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        turn(36, 0.3);            // turn towards the beacon
        drive(100, 1);           // drives to get close to the line
        driveToLine(0.1);          // drives until the robot see the line
        drive(3, 0.4);             // drives a little bit further
        turn(56, 0.3);            // turn so the front of the robot is facing the beacon // was 51
        ...
        driveSecondLine(76, 0.1);          // drives to the line
    ...
    public void driveSecondLine(int distance, double power){
        ...
        while (opModeIsActive() && !seeLine() && robot.ultiL.getUltrasonicLevel() > distance) {
    ...
    public void fixBeacon(){
        if(robot.ColoradoReader.read8(4) == 10) {

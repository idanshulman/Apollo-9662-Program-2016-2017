...
@Autonomous(name="REDY", group="AUTONOMUS")
//@Disabled
public class Autonomous_READY extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        driveToDis(11, 0.12);
        fixBeacon();
        drive(-10, 0.5);           // get away from beacon
        ...
        driveToDis(11, 0.12);  // drives to the wall and click beacon
        fixBeacon();
        drive(-13,0.5);
        turn(42, 0.3);
        drive(-150, 1);
